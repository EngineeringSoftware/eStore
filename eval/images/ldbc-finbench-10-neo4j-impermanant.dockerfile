...
RUN apt-get update -y &&\
    ...
    wget -O sf10.tar.gz -L https://utexas.box.com/shared/static/z5644vnlxbyvvw3myqboj3yiiexcjlu7.gz &&\
    gzip -d sf10.tar.gz &&\
    tar -xvf sf10.tar && rm *.tar &&\
...
COPY --chown=$username ./estore/ldbc/finbench/src/test/java/org/estore/eval/estore/ldbc/finbench/Neo4jImpermanantTest10 /neo4j/community/community-it/kernel-it/src/test/java/org/neo4j/kernel/impl/core/Neo4jImpermanantTest10.java
