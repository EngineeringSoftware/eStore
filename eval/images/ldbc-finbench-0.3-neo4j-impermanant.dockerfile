...
RUN apt-get update -y &&\
    ...
    wget -O sf0.3.tar.gz -L https://utexas.box.com/shared/static/1984vxn9l16pqg6fos9m3m8q10vglwk6.gz &&\
    gzip -d sf0.3.tar.gz &&\
    tar -xvf sf0.3.tar && rm *.tar &&\
...
COPY --chown=$username ./estore/ldbc/finbench/src/test/java/org/estore/eval/estore/ldbc/finbench/Neo4jImpermanantTest03 /neo4j/community/community-it/kernel-it/src/test/java/org/neo4j/kernel/impl/core/Neo4jImpermanantTest03.java
