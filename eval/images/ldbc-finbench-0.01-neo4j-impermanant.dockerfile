...
COPY --chown=$username ./estore/ldbc/finbench/src/test/java/org/estore/eval/estore/ldbc/finbench/Neo4jImpermanantTest001 /neo4j/community/community-it/kernel-it/src/test/java/org/neo4j/kernel/impl/core/Neo4jImpermanantTest001.java
