...
# Install MAVEN and download the dataset for LDBC FinBench SF 3
RUN apt-get update -y &&\
    ...
    wget -O test.tar.gz -L "https://drive.usercontent.google.com/download?id=18oe1LEZvi5EusseswQE6ftiUxCsx4A92&export=download&authuser=0&confirm=t&uuid=971b21ed-db6a-4c84-b4d1-db510b9ea4f8&at=APZUnTWZ702p54DH7frTbxTgQijv:1701486595409" &&\
    gzip -d test.tar.gz &&\
