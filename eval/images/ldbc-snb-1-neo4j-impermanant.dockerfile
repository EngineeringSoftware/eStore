...
RUN wget -O maven.tar.gz -L https://dlcdn.apache.org/maven/maven-3/3.9.5/binaries/apache-maven-3.9.5-bin.tar.gz &&\
    ...
    wget -O social_network-csv_composite-longdateformatter-sf1.tar.gz -L https://utexas.box.com/shared/static/n3byx2rizgj4s53fponpbgbfgq4hsrtn.gz &&\
    gzip -d social_network-csv_composite-longdateformatter-sf1.tar.gz &&\
...
WORKDIR /social_network-csv_composite-longdateformatter-sf1
...
COPY --chown=$username ./estore/ldbc/snb/src/test/java/org/estore/eval/estore/ldbc/snb/Neo4jImpermanantTest1 /neo4j/community/community-it/kernel-it/src/test/java/org/neo4j/kernel/impl/core/Neo4jImpermanantTest1.java
