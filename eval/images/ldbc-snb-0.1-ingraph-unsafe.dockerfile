...
RUN apt-get update -y &&\
    ...
    wget --no-check-certificate https://repository.surfsara.nl/datasets/cwi/snb/files/social_network-csv_composite-longdateformatter/social_network-csv_composite-longdateformatter-sf0.1.tar.zst &&\
    zstd -d social_network-csv_composite-longdateformatter-sf0.1.tar.zst &&\
