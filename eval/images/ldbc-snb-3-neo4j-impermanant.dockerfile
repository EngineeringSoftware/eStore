...
RUN apt-get update -y &&\
    ...
    gzip -d social_network-csv_composite-longdateformatter-sf3.tar.gz &&\
    tar -xvf social_network-csv_composite-longdateformatter-sf3.tar && rm *.tar &&\
...
WORKDIR /social_network-csv_composite-longdateformatter-sf3
...
COPY --chown=$username ./estore/ldbc/snb/src/test/java/org/estore/eval/estore/ldbc/snb/Neo4jImpermanantTest3 /neo4j/community/community-it/kernel-it/src/test/java/org/neo4j/kernel/impl/core/Neo4jImpermanantTest3.java
