...
RUN apt-get update -y &&\
    ...
    wget -O sf0.1.tar.gz -L https://utexas.box.com/shared/static/byxpy7mqrwyvkmej8tfct1ww3wbla45u.gz &&\
    gzip -d sf0.1.tar.gz &&\
    tar -xvf sf0.1.tar && rm *.tar &&\
...
COPY --chown=$username ./estore/ldbc/finbench/src/test/java/org/estore/eval/estore/ldbc/finbench/Neo4jImpermanantTest01 /neo4j/community/community-it/kernel-it/src/test/java/org/neo4j/kernel/impl/core/Neo4jImpermanantTest01.java
