...
public class EstoreNeoTestLinkedList100000 {
  ...
  public void testFindElement() throws Exception {
    ...
    Object result[] =
        query(
            this,
            "MATCH (n {$1})-[*1..99999]->(m)-[:item]->(p {value:"
                + ((long) list.get(ind))
                + "}) RETURN p.value",
            list);
    ...
    assertEquals(
        ((Long) result[0]), list.get(ind), "Find element failed for EstoreNeoTestLinkedList100000");
  }
}
