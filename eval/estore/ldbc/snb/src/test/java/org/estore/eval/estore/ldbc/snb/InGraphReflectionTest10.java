...
public class InGraphReflectionTest10 {
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Person`"
                + " {id:6597069780295})-[likes:LIKES2]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Post;`"
  ...
  public void testInteractiveDeleteQuery3() {
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Person`"
                + " {id:6597069815834})-[likes:LIKES1]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Comment;`"
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Forum`"
                + " {id:1099511627777})-[hasMember:HAS_MEMBER]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Person;`"
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Comment`"
                + " {id:7146825883053})-[:HAS_CREATOR]->(p:`[Lorg.estore.eval.estore.ldbc.snb.util.Person;`)"
  ...
  public void testInteractiveUpdateQuery2() {
    Table result =
        estore.query(
            "MATCH (person:`org.estore.eval.estore.ldbc.snb.util.Person` {id:6597069815834}),"
                + " (post:`org.estore.eval.estore.ldbc.snb.util.Post` {id:6047313953017})  CREATE"
    ...
    Table result =
        estore.query(
            "MATCH (person:`org.estore.eval.estore.ldbc.snb.util.Person` {id:6597069780295}),"
                + " (comment:`org.estore.eval.estore.ldbc.snb.util.Comment` {id:3848290697802})  CREATE"
  ...
  public void testInteractiveUpdateQuery5() {
    Table result =
        estore.query(
            "MATCH (f:`org.estore.eval.estore.ldbc.snb.util.Forum` {id:1099511627777}),"
                + " (p:`org.estore.eval.estore.ldbc.snb.util.Person` {id:8796093058058})  CREATE"
    ...
    Table result =
        estore.query(
            "MATCH (p1:`org.estore.eval.estore.ldbc.snb.util.Person` {id:2199023256684}),"
                + " (p2:`org.estore.eval.estore.ldbc.snb.util.Person` {id:17592186114273})  CREATE"
