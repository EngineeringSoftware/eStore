...
public class InGraphReflectionTest1 {
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Person`"
                + " {id:6597069777240})-[likes:LIKES2]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Post;`"
  ...
  public void testInteractiveDeleteQuery3() {
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Person`"
                + " {id:32985348833579})-[likes:LIKES1]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Comment;`"
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Forum`"
                + " {id:1786706395137})-[hasMember:HAS_MEMBER]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Person;`"
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Comment`"
                + " {id:1511828523046})-[:HAS_CREATOR]->(p:`[Lorg.estore.eval.estore.ldbc.snb.util.Person;`)"
  ...
  public void testInteractiveUpdateQuery2() {
    Table result =
        estore.query(
            "MATCH (person:`org.estore.eval.estore.ldbc.snb.util.Person` {id:6597069777240}),"
                + " (post:`org.estore.eval.estore.ldbc.snb.util.Post` {id:549755815810})  CREATE"
  ...
  public void testInteractiveUpdateQuery3() {
    Table result =
        estore.query(
            "MATCH (person:`org.estore.eval.estore.ldbc.snb.util.Person` {id:10995116284808}),"
                + " (comment:`org.estore.eval.estore.ldbc.snb.util.Comment` {id:824633722450})  CREATE"
                + " (person)-[:LIKES1]->(comment) RETURN COUNT(r)");
    assertEquals(result.get("COUNT(r)").get(0), 1);
  }
  ...
  public void testInteractiveUpdateQuery5() {
    Table result =
        estore.query(
            "MATCH (f:`org.estore.eval.estore.ldbc.snb.util.Forum` {id:1374389534723}),"
                + " (p:`org.estore.eval.estore.ldbc.snb.util.Person` {id:32985348838375})  CREATE"
                + " (f)-[:HAS_MEMBER]->(p) RETURN COUNT(r)");
    assertEquals(result.get("COUNT(r)").get(0), 1);
  }
    ...
    Table result =
        estore.query(
            "MATCH (p1:`org.estore.eval.estore.ldbc.snb.util.Person` {id:2199023256684}),"
                + " (p2:`org.estore.eval.estore.ldbc.snb.util.Person` {id:21990232560132})  CREATE"
                + " (p1)-[:KNOWS]->(p2) RETURN COUNT(r)");
    assertEquals(result.get("COUNT(r)").get(0), 1);
  }
  ...
  public void readDataSet() throws Exception {
    ...
    String datasetPath = "/social_network-csv_composite-longdateformatter-sf1";
