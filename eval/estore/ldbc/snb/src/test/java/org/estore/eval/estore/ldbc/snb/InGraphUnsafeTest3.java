...
public class InGraphUnsafeTest3 {
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Person`"
                + " {id:6597069786683})-[likes:LIKES2]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Post;`"
  ...
  public void testInteractiveDeleteQuery3() {
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Person`"
                + " {id:6597069780295})-[likes:LIKES1]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Comment;`"
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Forum`"
                + " {id:2748779069441})-[hasMember:HAS_MEMBER]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Person;`"
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Comment`"
                + " {id:2199023299651})-[:HAS_CREATOR]->(p:`[Lorg.estore.eval.estore.ldbc.snb.util.Person;`)"
  ...
  public void testInteractiveUpdateQuery2() {
    Table result =
        estore.query(
            "MATCH (person:`org.estore.eval.estore.ldbc.snb.util.Person` {id:6597069786683}),"
                + " (post:`org.estore.eval.estore.ldbc.snb.util.Post` {id:1924145349113})  CREATE"
  ...
  public void testInteractiveUpdateQuery3() {
    Table result =
        estore.query(
            "MATCH (person:`org.estore.eval.estore.ldbc.snb.util.Person` {id:6597069780295}),"
                + " (comment:`org.estore.eval.estore.ldbc.snb.util.Comment` {id:2199023256180})  CREATE"
  ...
  public void testInteractiveUpdateQuery5() {
    Table result =
        estore.query(
            "MATCH (f:`org.estore.eval.estore.ldbc.snb.util.Forum` {id:2748779069441}),"
                + " (p:`org.estore.eval.estore.ldbc.snb.util.Person` {id:19791209317730})  CREATE"
    ...
    Table result =
        estore.query(
            "MATCH (p1:`org.estore.eval.estore.ldbc.snb.util.Person` {id:2199023256684}),"
                + " (p2:`org.estore.eval.estore.ldbc.snb.util.Person` {id:30786325587981})  CREATE"
  ...
  public void readDataSet() throws Exception {
    ...
    String datasetPath = "/social_network-csv_composite-longdateformatter-sf3";
