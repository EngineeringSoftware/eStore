...
public class InGraphReflectionTest03 {
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Person`"
                + " {id:24189255814068})-[likes:LIKES2]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Post;`"
                + " {id:481036337191}) DELETE likes RETURN COUNT(m)");
  ...
  public void testInteractiveDeleteQuery3() {
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Person`"
                + " {id:2199023256437})-[likes:LIKES1]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Comment;`"
                + " {id:1030792151057}) DELETE likes RETURN COUNT(m)");
    assertEquals(result.get("COUNT(m)").get(0), 1);
  }
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Forum`"
                + " {id:893353197569})-[hasMember:HAS_MEMBER]->(:`[Lorg.estore.eval.estore.ldbc.snb.util.Person;`"
                + " {id:24189255814068}) DELETE hasMember RETURN COUNT(m)");
    assertEquals(result.get("COUNT(m)").get(0), 1);
  }
    ...
    Table result =
        estore.query(
            "MATCH (m:`org.estore.eval.estore.ldbc.snb.util.Comment`"
                + " {id:1030792151047})-[:HAS_CREATOR]->(p:`[Lorg.estore.eval.estore.ldbc.snb.util.Person;`)"
  ...
  public void testInteractiveUpdateQuery2() {
    ...
    Table result =
        estore.query(
            "MATCH (person:`org.estore.eval.estore.ldbc.snb.util.Person` {id:15393162790400}),"
                + " (post:`org.estore.eval.estore.ldbc.snb.util.Post` {id:206158430485})  CREATE"
  ...
  public void testInteractiveUpdateQuery3() {
    Table result =
        estore.query(
            "MATCH (person:`org.estore.eval.estore.ldbc.snb.util.Person` {id:6597069769310}),"
                + " (comment:`org.estore.eval.estore.ldbc.snb.util.Comment` {id:962072676825})  CREATE"
  ...
  public void testInteractiveUpdateQuery5() {
    Table result =
        estore.query(
            "MATCH (f:`org.estore.eval.estore.ldbc.snb.util.Forum` {id:893353197569}),"
                + " (p:`org.estore.eval.estore.ldbc.snb.util.Person` {id:15393162790400})  CREATE"
  ...
  public void testInteractiveUpdateQuery8() {
    Table result =
        estore.query(
            "MATCH (p1:`org.estore.eval.estore.ldbc.snb.util.Person` {id:2199023256684}),"
                + " (p2:`org.estore.eval.estore.ldbc.snb.util.Person` {id:4398046513209})  CREATE"
  ...
  public void readDataSet() throws EstoreException {
    ...
    String datasetPath = "/social_network-csv_composite-longdateformatter-sf0.3";
