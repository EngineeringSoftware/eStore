...
import org.estore.eval.estore.ldbc.finbench.util.*;
import org.estore.Estore;
import org.estore.EstoreOptions;
import org.estore.planner.util.Table;

public class InGraphReflectionTest001 {
  ...
  public void testTw1() {
    Table result =
        estore.query(
            "CREATE (:`org.estore.eval.estore.ldbc.finbench.util.Person` {personId: 1, personName:"
                + " 'George'})-[:Own]->(:`org.estore.eval.estore.ldbc.finbench.util.Account`"
  ...
  public void testTw2() {
    Table result =
        estore.query(
            "CREATE (:`org.estore.eval.estore.ldbc.finbench.util.Company` {companyId: 12345,"
                + " companyName: 'Rand'})-[:Own]->(:`org.estore.eval.estore.ldbc.finbench.util.Account`"
  ...
  public void testTw3() {
    Table result =
        estore.query(
            " MATCH (dst:`org.estore.eval.estore.ldbc.finbench.util.Account` {accountId:"
                + " 4619004367821865972}), (src:`org.estore.eval.estore.ldbc.finbench.util.Account`"
    ...
    Table result =
        estore.query(
            " MATCH (dst:`org.estore.eval.estore.ldbc.finbench.util.Account` {accountId:"
                ...
                + " (src:`org.estore.eval.estore.ldbc.finbench.util.Account` {accountId:"
  ...
  public void testTw8() {
    Table result =
        estore.query(
            "MATCH (acc:`org.estore.eval.estore.ldbc.finbench.util.Account` {accountId:"
                + " 4700350636091245930}), (loan:`org.estore.eval.estore.ldbc.finbench.util.Loan`"
  ...
  public void testTw13() {
    Table result =
        estore.query(
            "MATCH (p1:`org.estore.eval.estore.ldbc.finbench.util.Person` {personId: 2199023255767}),"
                + " (p2:`org.estore.eval.estore.ldbc.finbench.util.Person` {personId: 10995116278183})"
  ...
  public void testTsr1() {
    Table result =
        estore.query(
            "MATCH (account:`org.estore.eval.estore.ldbc.finbench.util.Account` {accountId:"
  ...
  private void insertLoans(String filePath, HashMap<Long, Loan> loans) {
    try {
      ...
      for (CSVRecord csvRecord : csvParser) {
        ...
        loans.put(
            loanId, new Loan(loanId, loanAmount, balance, createTime, loanUsage, interestRate));
      }
      csvParser.close();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  private void insertMediums(String filePath, HashMap<Long, Medium> mediums) {
    try {
      ...
      for (CSVRecord csvRecord : csvParser) {
        ...
        mediums.put(
            mediumId,
            new Medium(mediumId, mediumType, isBlocked, createTime, lastLoginTime, riskLevel));
      }
      csvParser.close();
    } catch (Exception e) {
      e.printStackTrace();
